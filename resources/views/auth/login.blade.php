...
<head>
    ...
    <!-- END: Custom CSS-->
    <style type="">
        .input-group-merge.form-password-toggle .input-group-text i[data-feather="eye"].error {
            color: red;
        }
    </style>
...
<body class="horizontal-layout horizontal-menu blank-page navbar-floating footer-static  " data-open="hover"
    ...
    <script>
        $(window).on('load', function() {
            ...
            let validationError = document.querySelector(
            ...
            if (validationError) {
                ...
                // Menghapus kelas "error" jika tidak ada error
                document.querySelector(
                        '.input-group-merge.form-password-toggle .input-group-text i[data-feather="eye"]').classList
                    .remove('error');
            }
